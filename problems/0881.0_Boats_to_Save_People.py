...
Runtime: 461 ms, faster than 66.17% of Python3 online submissions for Boats to Save People.
Memory Usage: 20.9 MB, less than 18.19% of Python3 online submissions for Boats to Save People.
'''
class Solution:
    def numRescueBoats(self, people: List[int], limit: int) -> int:
        people.sort()
